...
#include "CosmoInterface/measurements/ghostscalarsingletmeasurer.h"
...
namespace TempLat {
    ...
    public:
        ...
        Measurer(Model& model, const RunParameters<T>& par) :
          ...
          ghostscalarSingletMeasurer(model,filesManager, par, par.appendMode),   // Measurer for ghost scalar fields
        ...
        void measure(int n, R t, Model& model)
        {
            ...
            if( (n % outputFreq == 0 )  ){
              ...
              ghostscalarSingletMeasurer.measureStandard(model,t);
              // Means, rms, etc, of scalar singlet
    ...
    private:
        ...
        GhostScalarSingletMeasurer<T> ghostscalarSingletMeasurer;
