...
namespace TempLat {
    ...
    struct DefaultModelPars {
        ...
        static constexpr size_t NGhostScalars = 0; // ghost scalar singlets
...
#define MakeModel(_ModelName, _ModelParsType) AbstractModel<MakeAbstractModelTemplateArgs(_ModelName, _ModelParsType, double)>
    ...
    template<class R, size_t NPOTTERMS, size_t NGHOSTMASSTERMS, size_t NGHOSTPOTTERMS ,size_t NS, size_t NGS, size_t NC, size_t  NU1FLDS, size_t NSU2DOUBLET, size_t NSU2FLDS, typename CSU1COUPLINGS, typename SU2DOUBLETU1COUPLINGS, typename SU2DOUBLETSU2COUPLINGS,  typename T = double, int NDIM = 3>
    class AbstractModel {
    public:
        ...
        static constexpr size_t NGs = NGS;
        static constexpr size_t NCs = NC;
        static constexpr size_t NPotTerms = NPOTTERMS;
        static constexpr size_t NGhostMassTerms = NGHOSTMASSTERMS;
        static constexpr size_t NGhostPotTerms = NGHOSTPOTTERMS;
        ...
        // --> Averages ghost scalar
        T GSgrad2AvI, GSgrad2AvSI;
        T GSpi2AvSI, GSpi2AvSIM, GSpi2AvIM, GSpi2AvI;
        ...
        TempLatArray<T,NGs> masses2GS; // ghost scalar singlet
        ...
        void setInitialPotentialAndMassesFromPotential()
        {
            ...
            ForLoop(j, 0, NGs-1, masses2GS(j) = GetValue::get(Potential::deriv2GS(static_cast<R&>(*this),j),0));
            ForLoop(j, 0, NCs-1,
    ...
    private:
        ...
        void addInitValueOnePoint()
        {
            ...
            ForLoop(j, 0, NGs-1,fldGS(j).getSet(0) = fldGS0[j] / fStar);
            ForLoop(j, 0, NCs-1,
                    ForLoop(i,0,1,
        ...
        void removeInitValue()
        {
            ...
            ForLoop(j, 0, NGs-1,fldGS(j).getSet(0) = 0);
            ForLoop(j, 0, NCs-1,
                    ForLoop(i,0,1,
