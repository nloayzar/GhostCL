...
namespace TempLat {
    ...
    public:
        ...
        static inline auto gradientS(Model& model) {
         ...
         template<class Model>
        static inline auto kineticGS(Model& model) {
            return kineticS(model, model.GSpi2AvI);
        }

        template<class Model>
        static inline auto gradientGS(Model& model) {
            return gradientS(model, model.GSgrad2AvI);
        }
        ...
        template<class Model>
        static inline auto kineticGSSI(Model& model) {
            return kineticS(model, model.GSpi2AvSI);
        }

        template<class Model>
        static inline auto gradientGSSI(Model& model) {
            return gradientS(model, model.GSgrad2AvSI);
        }
        ...
        static inline auto rho(Model& model)  // Total energy density (sum of all contributions)
        {
            ...
            auto Ekgs = (model.NGs > 0 ?  kineticGS(model) : 0);
            ...
            auto Egghs =  (model.NGs > 0 ? gradientGS(model) : 0 );
            ...
            return  (
                    Eks - Ekgs + Ekcs + EkSU2Dbl
                    + Egs - Egghs + Egcs + EgSU2Dbl
                    + EelU1 + EmagU1
                    + EelSU2 + EmagSU2
